      ...
      <div className="container">
            ...
            <div className="header__right dropdown">
              ...
              >
                <li>
                  <Link
                    to="/login"
                    className={`dropdown-item ${isActive("/login")} text-black`}
                  >
                    <LoginIcon /> Login
                  </Link>
                </li>
                <li>
                  <Link
                    to="/sign-up"
                    className={`dropdown-item ${isActive("/sign-up")} text-black`}
                  >
                    <SignUpIcon /> Sign Up
                  </Link>
                </li>
        ...
        {mobileMenuOpen && (
          <div className="mobile-nav d-xl-none rounded-4">
            <ul>
              <li className={isActive("/")}>
                <Link to="/" onClick={toggleMobileMenu}>Homepage</Link>
              </li>
              <li className={isActive("/category/action")}>
                <Link to="/category/action" onClick={toggleMobileMenu}>Action</Link>
              </li>
              <li className={isActive("/category/horror")}>
                <Link to="/category/horror" onClick={toggleMobileMenu}>Horror</Link>
              </li>
              <li className={isActive("/category/fantasy")}>
                <Link to="/category/fantasy" onClick={toggleMobileMenu}>Fantasy</Link>
              </li>
              <li className={isActive("/category/drama")}>
                <Link to="/category/drama" onClick={toggleMobileMenu}>Drama</Link>
              </li>
              <li className={isActive("/contact-me")}>
                <Link to="/contact-me" onClick={toggleMobileMenu}>Contact Me</Link>
              </li>
              <li>
